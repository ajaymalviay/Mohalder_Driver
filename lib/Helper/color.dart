...
const Color primary = Color(0xffC1262C);
const Color secondary = Color(0xff01A89D);
const Color fontColor = Color(0xff080808);
const Color grad1Color = Color(0xffC1262C);
const Color grad2Color = Color(0xff01A89D);
const Color lightWhite2 = Color(0xffEEF2F3);

const Color disableColor = Color(0xffEEF2F9);
const Color pink = Color(0xffC1262C);
